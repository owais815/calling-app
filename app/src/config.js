...
module.exports = {
    ...
    api: {
        // Secret key shared with LMS backend — set via CALLING_APP_API_SECRET env var
    ...
    host: {
        ...
        */
        ...
        users: [
            {
                // LMS system account — used by callingAppService.js token generation.
                // username/password here must match what the backend embeds in the JWT.
                username: 'lms-system',
                password: 'lms-token',
                allowed_rooms: ['*'],
            },
