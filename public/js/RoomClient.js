...
class RoomClient {
    ...
    shareScreen() {
        // Screen share is started manually by the user via the bottom bar button.
        // No auto-prompt on join.
        console.log('11 ----> Screen share available, user can start via button');
    }
